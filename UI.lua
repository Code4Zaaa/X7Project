...
if CoreGui:FindFirstChild("SKAYSUI") then
    CoreGui.SKAYSUI:Destroy()
...
if not isfolder("Skays Addons") then
    ...
    writefile("Skays Addons/ColorDropper.png", ColorDropper.Body)
    ...
    writefile("Skays Addons/Close.png", Close.Body)
    ...
    writefile("Skays Addons/CollapseArrow.png", CollapseArrow.Body)
    ...
    writefile("Skays Addons/RadioButton.png", RadioButton.Body)
    ...
    writefile("Skays Addons/RadioOuter.png", RadioOuter.Body)
    ...
    writefile("Skays Addons/RadioInner.png", RadioInner.Body)
    dText.Text = "Downloaded: RadioInner.png"

    local Transparant = request({Url = "https://cdn.discordapp.com/attachments/1118504718059176076/1170674298944503878/tp.png?ex=6559e666&is=65477166&hm=f6d5016cf1cef3921672d872bf1a3f042e33f69fd89ac0af9f7770fea26e3fa3&", Method = "GET"})
    writefile("Skays Addons/Transparants.png", Transparant.Body)
    dText.Text = "Downloaded: Transparants.png"
...
Info.Text = Info.Text or "Skays"

local window = {}

local shamanScreenGui = Instance.new("ScreenGui")
shamanScreenGui.Name = "SKAYSUI"
...
newuICorner.CornerRadius = UDim.new(0, 5)
...
main.Size = UDim2.new(0, 520, 0, 305)
...
topbar.Size = UDim2.new(0, 519, 0, 31)
topbar.Parent = main
topbar.ZIndex = 2
...
frame.Size = UDim2.new(0, 519, 0, 11)
frame.Parent = topbar


local uICornerfr = Instance.new("UICorner")
uICornerfr.Name = "UICorner"
uICornerfr.CornerRadius = UDim.new(0, 8)
uICornerfr.Parent = frame
...
frame1.Position = UDim2.new(0.499582082, 0, 2.909091, 0)
frame1.Size = UDim2.new(0, 519, 0, 1)
frame1.ZIndex = 2
frame1.Parent = frame
...
textLabel.Position = UDim2.new(0.0127272727, 0, 0, 0)
...
minimizeButton.MouseEnter:Connect(function()
    TweenService:Create(minimizeButton, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = Color3.fromRGB(194, 207, 76)}):Play()
end)
...
minimizeButton.MouseButton1Click:Connect(function()
    ...
    for _,v in pairs(main.MainContainer:GetChildren()) do
       if v.Name == "LeftContainer" and v.Visible then
           v.Size = Opened and UDim2.new(0, 520,0, 305) or UDim2.new(0, 520,0, 0)
       end
    end
    end)
    
    TweenService:Create(main, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = Opened and UDim2.new(0, 520, 0, 305) or UDim2.new(0, 520,0, 30)}):Play()
end)
...
transpantButton.Position = UDim2.new(0.791, 0, 0.226, 0)
transpantButton.Size = UDim2.new(0, 15, 0, 15)
transpantButton.ZIndex = 3
transpantButton.Parent = topbar
...
tabContainer.Position = UDim2.new(0, 0, 0.0905, 0)
tabContainer.Size = UDim2.new(0, 110, 0, 291)
...
ScrollingContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
ScrollingContainer.BorderSizePixel = 0
ScrollingContainer.Position = UDim2.new(0, 0, 0.0126642417, 0)
ScrollingContainer.Size = UDim2.new(0, 114, 0, 287)
...
uIPaddingScroll.Name = "UIPadding"
uIPaddingScroll.PaddingLeft = UDim.new(0, 3)
uIPaddingScroll.PaddingTop = UDim.new(0, 2)
uIPaddingScroll.Parent = ScrollingContainer
...
ImageLabel.Position = UDim2.new(0.249425292, 0, 0.095588237, 0)
ImageLabel.Size = UDim2.new(0, 214, 0, 189)
ImageLabel.Image = "http://www.roblox.com/asset/?id=15250718308"
ImageLabel.ImageTransparency = 0.590
ImageLabel.ZIndex=2
...
tabButton.Size = UDim2.new(0, 101, 0, 27)


local uIPaddingTab = Instance.new("UIPadding")
uIPaddingTab.Name = "UIPadding"
uIPaddingTab.PaddingTop = UDim.new(0, 4)
uIPaddingTab.Parent = tabButton

local tabFrame = Instance.new("Frame")
tabFrame.Name = "TabFrame"
tabFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
tabFrame.BackgroundTransparency = .86
tabFrame.BorderSizePixel = 0
tabFrame.Size = UDim2.new(0, 93, 0, 27)
tabFrame.ZIndex = 2
...
tabFrame.MouseLeave:Connect(function()
    if TabSelected ~= tabFrame or TabSelected == nil then
        TweenService:Create(tabFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundTransparency = .86}):Play()
    end
end)

local tabTextButton = Instance.new("TextButton", tabFrame)
...
textLabel1.Size = UDim2.new(0, 93, 0, 23)
textLabel1.ZIndex = 2
...
local leftContainer
leftContainer = Instance.new("ScrollingFrame")
...
leftContainer.BackgroundColor3 = Color3.fromRGB(27, 27, 27)
leftContainer.BorderSizePixel = 0
leftContainer.Selectable = false
leftContainer.Size = UDim2.new(0, 410, 0, 273)
leftContainer.Parent = MainContainer
leftContainer.Visible = false

task.spawn(function()
    while true do
        if Transparant and leftContainer.BackgroundTransparency ~= 0.55 then
            leftContainer.BackgroundTransparency = 0.55
        else
            leftContainer.BackgroundTransparency = 0
        end
        task.wait(.1)
    end
...
section.Size = UDim2.new(0, 402, 0, 27)
section.Parent = Side
...
sectionFrame.Size = UDim2.new(0, 402, 0, 23)
...
task.spawn(function()
    while true do
        if Transparant and sectionFrame.BackgroundTransparency ~= 0.55 then
...
--sectionName.Position = UDim2.new(0.0208164233, 0, 0, 0)
sectionName.Size = UDim2.new(0, 402, 0, 23)
...
sectionButton.Size = UDim2.new(0, 402, 0, 27)
...
sectionIcon.Position = UDim2.new(1.02380955, -20, 0, 5)
...
Line.Position = UDim2.new(1.02380955, -210, 0, 25)
...
Line2.BackgroundColor3 = Color3.fromRGB(213, 213, 213)
Line2.BorderColor3 = Color3.fromRGB(0, 0, 0)
Line2.BorderSizePixel = 0
Line2.Position = UDim2.new(1.02380955, -210, 0, 24)
Line2.Size = UDim2.new(0, 0, 0, 2)

local UICornerLine = Instance.new("UICorner")
UICornerLine.Name = "KeybindUICorner"
UICornerLine.CornerRadius = UDim.new(0, 20)
UICornerLine.Parent = Line

local UICornerLine2 = Instance.new("UICorner")
UICornerLine2.Name = "KeybindUICorner"
UICornerLine2.CornerRadius = UDim.new(0, 20)
UICornerLine2.Parent = Line
...
sectionButton.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(Line2, TweenInfo.new(.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Size = Closed.Value and UDim2.new(0, -397, 0, 2) or UDim2.new(0, 0, 0, 2)}):Play()
    TweenService:Create(Line, TweenInfo.new(.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Size = Closed.Value and UDim2.new(0, 399, 0, 2) or UDim2.new(0, 0, 0, 2)}):Play()
    TweenService:Create(Line2, TweenInfo.new(.1, Enum.EasingStyle.Back, Enum.EasingDirection.In), {BackgroundTransparency = Closed.Value and 0 or 1}):Play()
    TweenService:Create(Line, TweenInfo.new(.1, Enum.EasingStyle.Back, Enum.EasingDirection.In), {BackgroundTransparency = Closed.Value and 0 or 1}):Play()
    TweenService:Create(UICornerLine, TweenInfo.new(.1, Enum.EasingStyle.Back, Enum.EasingDirection.In), {CornerRadius = Closed.Value and UDim.new(0, 20) or UDim.new(0, 3)}):Play()
    TweenService:Create(UICornerLine2, TweenInfo.new(.1, Enum.EasingStyle.Back, Enum.EasingDirection.In), {CornerRadius = Closed.Value and UDim.new(0, 20) or UDim.new(0, 3)}):Play()
    TweenService:Create(section, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = Closed.Value and UDim2.new(0, 402, 0, SizeY + 4) or UDim2.new(0, 402, 0, 27)}):Play()
    TweenService:Create(sectionFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = Closed.Value and UDim2.new(0, 402, 0, SizeY) or UDim2.new(0, 402, 0, 23)}):Play()
...
label.Size = UDim2.new(0, 402, 0, 27)
...
labelText.Position = UDim2.new(0.0208164233, 0, 0, 0)
labelText.Size = UDim2.new(0, 163, 0, 27)
...
keybind.Size = UDim2.new(0, 400, 0, 27)
...
keybindText.Position = UDim2.new(0.0208164233, 0, 0, 0)
keybindText.Size = UDim2.new(0, 163, 0, 27)
...
keybindFrame.Position = UDim2.new(0, 399, 0.222, 0)
...
button.Size = UDim2.new(0, 402, 0, 27)
...
buttonText.Size = UDim2.new(0, 402, 0, 27)
...
TextButton.Size = UDim2.new(0, 402, 0, 27)
...
input.Size = UDim2.new(0, 400, 0, 27)
...
inputFrame.Size = UDim2.new(0, 400, 0, 27)
inputFrame.Parent = input

local inputOuter = Instance.new("Frame")
inputOuter.Name = "InputOuter"
inputOuter.AnchorPoint = Vector2.new(0.5, 0.5)
inputOuter.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
inputOuter.BorderSizePixel = 0
inputOuter.ClipsDescendants = true
inputOuter.Position = UDim2.new(0.5098, 0, 0.5, 0)
inputOuter.Size = UDim2.new(0, 390, 0, 21)
...
local ColorDefault = Color3.fromHex("#A8CF45")
...
toggle.Size = UDim2.new(0, 402, 0, 27)
...
toggleText.Position = UDim2.new(0.0208164233, 0, 0, 0)
toggleText.Size = UDim2.new(0, 163, 0, 27)
...
toggleButton.Position = UDim2.new(0.910579689, 0, 0.222222224, 0)
...
toggleFrame.BackgroundColor3 = Color3.fromHex("#ED3237")
toggleFrame.BorderSizePixel = 0
toggleFrame.Position = UDim2.new(0.910579689, 0, 0.222222224, 0)
...
function insidetoggle:Set(bool)
    ...
    if not Toggled then
        Info.Default = false;
        TweenService:Create(toggleFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromHex("#ED3237")}):Play()
    elseif Toggled and not EditOpened then
        TweenService:Create(toggleFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = (Info.Default and ColorDefault) or Color3.fromHex("#0098DA")}):Play()
    end
...
sliderText.Position = UDim2.new(0.0218, 0, 0, 0)
sliderText.Size = UDim2.new(0, 390, 0, 27)
sliderText.Parent = slider

local outerSlider = Instance.new("Frame")
outerSlider.Name = "OuterSlider"
outerSlider.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
outerSlider.BorderSizePixel = 0
outerSlider.Position = UDim2.new(0.0208164233, -1, 0.664, 0)
outerSlider.Size = UDim2.new(0, 390, 0, 4)
...
innerSlider.BackgroundColor3 = Color3.fromHex("#F58634")
...
sliderValueText.Position = UDim2.new(0.0208164233, 0, 0, 0)
sliderValueText.Size = UDim2.new(0, 390, 0, 27)
...
sliderButton.Size = UDim2.new(0, 390, 0, 4)
...
dropdown.Size = UDim2.new(0, 402, 0, 27)
...
dropdownText.Position = UDim2.new(0.0208164233, 0, 0, 0)
dropdownText.Size = UDim2.new(0, 163, 0, 27)
...
dropdownIcon.Position = UDim2.new(0, 395, 0, 7)
...
dropdownButton.Size = UDim2.new(0, 402, 0, 27)
dropdownButton.Parent = dropdown

local dropdownContainer = Instance.new("Frame")
dropdownContainer.Name = "DropdownContainer"
dropdownContainer.BackgroundColor3 = Color3.fromRGB(5, 1, 1)
dropdownContainer.BackgroundTransparency = 1
dropdownContainer.BorderSizePixel = 0
dropdownContainer.Size = UDim2.new(0, 402, 0, 112)
...
function insidedropdown:Add(text)
    ...
    dropdownContainerButton.Size = UDim2.new(0, 402, 0, 27)
    ...
    dropdownbuttonText.RichText = true
    ...
    dropdownbuttonText.Position = UDim2.new(0.0208164233, 0, 0, 0)
    ...
    dropdownContainerTextButton.Size = UDim2.new(0, 402, 0, 27)
    ...
    dropdownContainerTextButton.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(dropdown, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = DropdownOpened and UDim2.new(0, 402, 0, DropdownYSize) or UDim2.new(0, 402, 0, 27)}):Play()
        TweenService:Create(dropdownContainer, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = DropdownOpened and UDim2.new(0, 402, 0, DropdownYSize) or UDim2.new(0, 402, 0, 27)}):Play()
        ...
        TweenService:Create(sectionFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = DropdownOpened and UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset + DropdownYSize - 27) or UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset - DropdownYSize + 27)}):Play()
        TweenService:Create(section, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = DropdownOpened and UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset + DropdownYSize - 27 + 4) or UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset - DropdownYSize + 31)}):Play()
    end)
end
...
function insidedropdown:Refresh(RefreshInfo)
    ...
    for _,v in pairs(dropdownContainer:GetChildren()) do
        if v.ClassName == "Frame" then
            ...
            if DropdownOpened then
                sectionFrame.Size = UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset - 27)
                section.Size = UDim2.new(0, 402, 0, section.Size.Y.Offset - 23)
            end
            v:Destroy()
        end
    end
    ...
    TweenService:Create(dropdownIcon, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = DropdownOpened and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(191, 191, 191)}):Play()
    TweenService:Create(dropdown, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = DropdownOpened and UDim2.new(0, 402, 0, DropdownYSize) or UDim2.new(0, 402, 0, 27)}):Play()
    TweenService:Create(dropdownContainer, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = DropdownOpened and UDim2.new(0, 402, 0, DropdownYSize) or UDim2.new(0, 402, 0, 23)}):Play()
    TweenService:Create(dropdownContainer, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundTransparency = DropdownOpened and .96 or 1}):Play()
end
...
radioButton.Size = UDim2.new(0, 402, 0, 27)
...
button.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
button.BackgroundTransparency = 1
button.Size = UDim2.new(0, 400, 0, 27)
...
radioButtonTextButton.Size = UDim2.new(0, 400, 0, 27)
...
radioButtonText.Position = UDim2.new(0.0208164233, 0, 0, 0)
radioButtonText.Size = UDim2.new(0, 402, 0, 27)
...
radioButtonIcon.Position = UDim2.new(0, 395, 0, 7)
...
radioButtonIcon2.Position = UDim2.new(0, 383, 0, 7)
...
radioContainer.Size = UDim2.new(0, 400, 0, 27)
...
radio.Size = UDim2.new(0, 402, 0, 27)
...
radioTextButton.Size = UDim2.new(0, 402, 0, 27)
...
radioOuter.Position = UDim2.new(0.925, 0, 0.185, 0)
...
radioText.Position = UDim2.new(0.0208164233, 0, 0, 0)
radioText.Size = UDim2.new(0, 163, 0, 27)
...
radioTextButton.MouseButton1Click:Connect(function()
    ...
    if not EditOpened then
        TweenService:Create(radioInner, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = RadioOpened and Color3.fromHex("#C75EA3") or Color3.fromRGB(191, 191, 191)}):Play()
        TweenService:Create(radioOuter, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = RadioOpened and Color3.fromHex("#C75EA3") or Color3.fromRGB(191, 191, 191)}):Play()
    end
end)
...
radioButtonTextButton.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(radioButton, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = RadioOpened and UDim2.new(0, 402, 0, RadioYSize) or UDim2.new(0, 402, 0, 27)}):Play()
    TweenService:Create(radioContainer, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = RadioOpened and UDim2.new(0, 402, 0, RadioYSize) or UDim2.new(0, 402, 0, 27)}):Play()
    ...
    TweenService:Create(sectionFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = RadioOpened and UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset + RadioYSize - 27) or UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset - RadioYSize + 27)}):Play()
    TweenService:Create(section, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = RadioOpened and UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset + RadioYSize - 27 + 4) or UDim2.new(0, 402, 0, sectionFrame.Size.Y.Offset - RadioYSize + 31)}):Play()
end)
...
return sectiontable
    ...
    tabTextButton.MouseButton1Click:Connect(function()
        ...
        for _,v in pairs(ScrollingContainer:GetChildren()) do
            if v ~= tabFrame and v.Name == "TabButton" then
...
transpantButton.MouseButton1Click:Connect(function()
    Transparant = not Transparant
    
    if not Transparant then
