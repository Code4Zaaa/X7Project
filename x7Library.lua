...
if CoreGui:FindFirstChild("X7UI") then
    CoreGui.X7UI:Destroy()
...
if Core:FindFirstChild("X7Notif") then Core:FindFirstChild("X7Notif"):Destroy() end
local UI = New("ScreenGui", {
	["IgnoreGuiInset"] = true; ["Name"] = "X7Notif"; ["ResetOnSpawn"] = false; ["ZIndexBehavior"] = "Global"
}); UI["Parent"] = Core;
...
function library:TextConstraint(Item)
	New("UITextSizeConstraint", {Parent = Item, MaxTextSize = Item["TextSize"]}); Item["TextScaled"] = true
end

function library:ApplyTheme(Theme, Frame)
    local Desc = Frame:GetDescendants()
    if library["Themes"][Theme:lower()] then
        for i,v in next, library["Themes"][Theme:lower()] do
...
function library:Notify(Title, Message, Type, Duration)
    library["Config"] = { ["Theme"] = "dark" }
	local Type2Color = {['error'] = Color3.fromRGB(255, 87, 87), ['warn'] = Color3.fromRGB(255, 255, 127), ['success'] = Color3.fromRGB(39,90,234), ['normal'] = Color3.fromRGB(255, 255, 255)}
	...
	local Header = New("TextLabel", {Parent = Frame, BackgroundTransparency = 1, Position = UDim2.new(0.237, 0, 0.172, 0), Size = UDim2.new(0.4, 0, 0.358, 0), ZIndex = 2, Font = "GothamMedium",
		Text = Title or "X7", TextSize = 14, TextXAlignment = "Left", TextScaled = true, TextColor3 = Color3.new(1, 1, 1)
	}); library:TextConstraint(Header);
    ...
    library:ApplyTheme((library["Config"]["Theme"]), Frame)
    if library["Config"]["Theme"]:lower() == "light" and Type:lower() == "normal" then 
...
local getcustomasset = (syn and getsynasset) or getcustomasset
local isfolder = isfolder or syn_isfolder or is_folder
local makefolder = makefolder or make_folder or createfolder or create_folder

if not isfolder("X7Project Addons/Properties/Images") then
    ...
    dMain.BackgroundColor3 = Color3.fromRGB(26, 28, 32)
    ...
    dTopbar.BackgroundColor3 = Color3.fromRGB(8, 8, 12)
    ...
    makefolder("X7Project Addons/Properties/Images")
        
    local Circle = request({Url = "https://raw.githubusercontent.com/Rain-Design/Icons/main/Circle.png", Method = "GET"})
    writefile("X7Project Addons/Properties/Images/Circle.png", Circle.Body)
    dText.Text = "Downloaded: <font color='rgb(255, 255, 255)'><b><u>Circle.png</u></b> </font>"
        
    local ColorDropper = request({Url = "https://raw.githubusercontent.com/Rain-Design/Icons/main/ColorDropper.png", Method = "GET"})
    writefile("X7Project Addons/Properties/Images/ColorDropper.png", ColorDropper.Body)
    dText.Text = "Downloaded: <font color='rgb(255, 255, 255)'><b><u>ColorDropper.png</u></b> </font>"

    local Close = request({Url = "https://raw.githubusercontent.com/Rain-Design/Icons/main/Close.png", Method = "GET"})
    writefile("X7Project Addons/Properties/Images/Close.png", Close.Body)
    dText.Text = "Downloaded: <font color='rgb(255, 255, 255)'><b><u>Close.png</u></b> </font>"

    local CollapseArrow = request({Url = "https://raw.githubusercontent.com/Rain-Design/Icons/main/CollapseArrow.png", Method = "GET"})
    writefile("X7Project Addons/Properties/Images/CollapseArrow.png", CollapseArrow.Body)
    dText.Text = "Downloaded: <font color='rgb(255, 255, 255)'><b><u>CollapseArrow.png</u></b> </font>"
        
    local RadioButton = request({Url = "https://raw.githubusercontent.com/Rain-Design/Icons/main/RadioButton.png", Method = "GET"})
    writefile("X7Project Addons/Properties/Images/RadioButton.png", RadioButton.Body)
    dText.Text = "Downloaded: <font color='rgb(255, 255, 255)'><b><u>RadioButton.png</u></b> </font>"
        
    local RadioOuter = request({Url = "https://raw.githubusercontent.com/Rain-Design/Icons/main/RadioOuter.png", Method = "GET"})
    writefile("X7Project Addons/Properties/Images/RadioOuter.png", RadioOuter.Body)
    dText.Text = "Downloaded: <font color='rgb(255, 255, 255)'><b><u>RadioOuter.png</u></b> </font>"
        
    local RadioInner = request({Url = "https://raw.githubusercontent.com/Rain-Design/Icons/main/RadioInner.png", Method = "GET"})
    writefile("X7Project Addons/Properties/Images/RadioInner.png", RadioInner.Body)
    dText.Text = "Downloaded: <font color='rgb(255, 255, 255)'><b><u>RadioInner.png</u></b> </font>"
...
Info.Text = Info.Text or "<font color='rgb(39,90,234)'><b>X7</b></font><font1 color='rgb(255, 255, 255)'><b> Project - "..tostring("@x7Vytnh").."</b></font1>" 

local window = {}

local shamanScreenGui = Instance.new("ScreenGui")
shamanScreenGui.Name = "X7UI"
...
local function Tooltip(text)
    local X, Y = library:GetTextBounds(text, Enum.Font.GothamBold, 11);

    local tooltip = Instance.new("Frame")
    tooltip.Name = "Tooltip"
    tooltip.AnchorPoint = Vector2.new(0.5, 0)
    tooltip.BackgroundColor3 = Color3.fromRGB(26, 28, 32)
    tooltip.Visible = false
    tooltip.Position = UDim2.new(0.352, 0, 0.0741, 0)
    tooltip.Size = UDim2.fromOffset(X + 5, Y + 4)--UDim2.new(0, 100, 0, 19)
    tooltip.ZIndex = 5
    ...
    tooltipText.Position = UDim2.fromOffset(3, 1)
    tooltipText.BackgroundTransparency = 1
    tooltipText.Size = UDim2.fromOffset(X, Y)-- UDim2.new(0, 100, 0, 19)
    ...
    tooltipText.Size = UDim2.fromOffset(X, Y)
...
frame1.BackgroundColor3 = Color3.fromRGB(52, 52, 52)
...
closeButton.Image = getcustomasset("X7Project Addons/Properties/Images/Close.png")
...
function library:show(state)
    state  = not state
    if state then
        TweenService:Create(main, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = state and UDim2.new()}):Play()
    else
        TweenService:Create(main, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = not state and UDim2.new(0, 450, 0, 321)}):Play()
    end
end

local editButton = Instance.new("ImageButton")
editButton.Name = "EditButton"
editButton.Image = getcustomasset("X7Project Addons/Properties/Images/ColorDropper.png")
...
tabContainer.BackgroundColor3 = Color3.fromRGB(8, 8, 12)
...
fix.Name = "Fix"
fix.BackgroundColor3 = Color3.fromRGB(8, 8, 12)
...
fix1.Name = "Fix"
fix1.BackgroundColor3 = Color3.fromRGB(8, 8, 12)
...
section.BackgroundColor3 = Color3.fromRGB(26, 28, 32)
...
sectionFrame.BackgroundColor3 = Color3.fromRGB(26, 28, 32)
...
keybindFrame.BackgroundColor3 = Color3.fromRGB(26, 28, 32)
...
Info.Interact = Info.Interact or ""
Info.Callback = Info.Callback or function() end
Info.Tooltip = Info.Tooltip or ""
...
if Info.Interact ~= "" then
    buttonText.Text = Info.Interact.." "..Info.Text
end
...
function insidebutton:Set(text, interact)
    if not text then text="" end
    if not interact then interact="" end
    buttonText.Text = interact.." "..text
end
...
inputOuter.BackgroundColor3 = Color3.fromRGB(26, 28, 32)
...
circleIcon.Image = getcustomasset("X7Project Addons/Properties/Images/Circle.png")
...
function insidetoggle:Set(bool)
    ...
    if not Toggled then
        TweenService:Create(toggleFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(34, 34, 34)}):Play()
...
outerSlider.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
...
dropdownIcon.Image = getcustomasset("X7Project Addons/Properties/Images/CollapseArrow.png")
...
function insidedropdown:Refresh(RefreshInfo)
    ...
    dropdownText.Text = RefreshInfo.Text
...
radioButtonIcon.Image = getcustomasset("X7Project Addons/Properties/Images/CollapseArrow.png")
...
radioButtonIcon2.Image = getcustomasset("X7Project Addons/Properties/Images/RadioButton.png")
...
radioOuter.Image = getcustomasset("X7Project Addons/Properties/Images/RadioOuter.png")
...
radioInner.Image = getcustomasset("X7Project Addons/Properties/Images/RadioInner.png")
